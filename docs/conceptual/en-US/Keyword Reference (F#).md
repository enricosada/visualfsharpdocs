...
|-------|----|-----------|
|**abstract**|[Members &#40;F&#35;&#41;](Members+28%F%2329%.md)<br /><br />[Abstract Classes &#40;F&#35;&#41;](Abstract+Classes+28%F%2329%.md)|Indicates a method that either has no implementation in the type in which it is declared or that is virtual and has a default implementation.|
|**and**|[let Bindings &#40;F&#35;&#41;](let+Bindings+28%F%2329%.md)<br /><br />[Members &#40;F&#35;&#41;](Members+28%F%2329%.md)<br /><br />[Constraints &#40;F&#35;&#41;](Constraints+28%F%2329%.md)|Used in mutually recursive bindings, in property declarations, and with multiple constraints on generic parameters.|
|**as**|[Classes &#40;F&#35;&#41;](Classes+28%F%2329%.md)<br /><br />[Pattern Matching &#40;F&#35;&#41;](Pattern+Matching+28%F%2329%.md)|Used to give the current class object an object name. Also used to give a name to a whole pattern within a pattern match.|
|**assert**|[Assertions &#40;F&#35;&#41;](Assertions+28%F%2329%.md)|Used to verify code during debugging.|
|**base**|[Classes &#40;F&#35;&#41;](Classes+28%F%2329%.md)<br /><br />[Inheritance &#40;F&#35;&#41;](Inheritance+28%F%2329%.md)|Used as the name of the base class object.|
|**begin**|[Verbose Syntax &#40;F&#35;&#41;](Verbose+Syntax+28%F%2329%.md)|In verbose syntax, indicates the start of a code block.|
|**class**|[Classes &#40;F&#35;&#41;](Classes+28%F%2329%.md)|In verbose syntax, indicates the start of a class definition.|
|**default**|[Members &#40;F&#35;&#41;](Members+28%F%2329%.md)|Indicates an implementation of an abstract method; used together with an abstract method declaration to create a virtual method.|
|**delegate**|[Delegates &#40;F&#35;&#41;](Delegates+28%F%2329%.md)|Used to declare a delegate.|
|**do**|[do Bindings &#40;F&#35;&#41;](do+Bindings+28%F%2329%.md)<br /><br />[Loops: for...to Expression &#40;F&#35;&#41;](Loops%3A+for...to+Expression+28%F%2329%.md)<br /><br />[Loops: for...in Expression &#40;F&#35;&#41;](Loops%3A+for...in+Expression+28%F%2329%.md)<br /><br />[Loops: while...do Expression &#40;F&#35;&#41;](Loops%3A+while...do+Expression+28%F%2329%.md)|Used in looping constructs or to execute imperative code.|
|**done**|[Verbose Syntax &#40;F&#35;&#41;](Verbose+Syntax+28%F%2329%.md)|In verbose syntax, indicates the end of a block of code in a looping expression.|
|**downcast**|[Casting and Conversions &#40;F&#35;&#41;](Casting+and+Conversions+28%F%2329%.md)|Used to convert to a type that is lower in the inheritance chain.|
|**downto**|[Loops: for...to Expression &#40;F&#35;&#41;](Loops%3A+for...to+Expression+28%F%2329%.md)|In a **for** expression, used when counting in reverse.|
|**elif**|[Conditional Expressions: if... then...else &#40;F&#35;&#41;](Conditional+Expressions%3A+if...+then...else+28%F%2329%.md)|Used in conditional branching. A short form of **else if**.|
|**else**|[Conditional Expressions: if... then...else &#40;F&#35;&#41;](Conditional+Expressions%3A+if...+then...else+28%F%2329%.md)|Used in conditional branching.|
|**end**|[Structures &#40;F&#35;&#41;](Structures+28%F%2329%.md)<br /><br />[Discriminated Unions &#40;F&#35;&#41;](Discriminated+Unions+28%F%2329%.md)<br /><br />[Records &#40;F&#35;&#41;](Records+28%F%2329%.md)<br /><br />[Type Extensions &#40;F&#35;&#41;](Type+Extensions+28%F%2329%.md)<br /><br />[Verbose Syntax &#40;F&#35;&#41;](Verbose+Syntax+28%F%2329%.md)|In type definitions and type extensions, indicates the end of a section of member definitions.<br /><br />In verbose syntax, used to specify the end of a code block that starts with the **begin** keyword.|
|**exception**|[Exception Handling &#40;F&#35;&#41;](Exception+Handling+28%F%2329%.md)<br /><br />[Exception Types &#40;F&#35;&#41;](Exception+Types+28%F%2329%.md)|Used to declare an exception type.|
|**extern**|[External Functions &#40;F&#35;&#41;](External+Functions+28%F%2329%.md)|Indicates that a declared program element is defined in another binary or assembly.|
|**false**|[Primitive Types &#40;F&#35;&#41;](Primitive+Types+28%F%2329%.md)|Used as a Boolean literal.|
|**finally**|[Exceptions: The try...finally Expression &#40;F&#35;&#41;](Exceptions%3A+The+try...finally+Expression+28%F%2329%.md)|Used together with **try** to introduce a block of code that executes regardless of whether an exception occurs.|
|**for**|[Loops: for...to Expression &#40;F&#35;&#41;](Loops%3A+for...to+Expression+28%F%2329%.md)<br /><br />[Loops: for...in Expression &#40;F&#35;&#41;](Loops%3A+for...in+Expression+28%F%2329%.md)|Used in looping constructs.|
|**fun**|[Lambda Expressions: The fun Keyword &#40;F&#35;&#41;](Lambda+Expressions%3A+The+fun+Keyword+28%F%2329%.md)|Used in lambda expressions, also known as anonymous functions.|
|**function**|[Match Expressions &#40;F&#35;&#41;](Match+Expressions+28%F%2329%.md)<br /><br />[Lambda Expressions: The fun Keyword &#40;F&#35;&#41;](Lambda+Expressions%3A+The+fun+Keyword+28%F%2329%.md)|Used as a shorter alternative to the **fun** keyword and a **match** expression in a lambda expression that has pattern matching on a single argument.|
|**global**|[Namespaces &#40;F&#35;&#41;](Namespaces+28%F%2329%.md)|Used to reference the top-level .NET namespace.|
|**if**|[Conditional Expressions: if... then...else &#40;F&#35;&#41;](Conditional+Expressions%3A+if...+then...else+28%F%2329%.md)|Used in conditional branching constructs.|
|**in**|[Loops: for...in Expression &#40;F&#35;&#41;](Loops%3A+for...in+Expression+28%F%2329%.md)<br /><br />[Verbose Syntax &#40;F&#35;&#41;](Verbose+Syntax+28%F%2329%.md)|Used for sequence expressions and, in verbose syntax, to separate expressions from bindings.|
|**inherit**|[Inheritance &#40;F&#35;&#41;](Inheritance+28%F%2329%.md)|Used to specify a base class or base interface.|
...
|**then**|[Conditional Expressions: if... then...else &#40;F&#35;&#41;](Conditional+Expressions%3A+if...+then...else+28%F%2329%.md)<br /><br />[Constructors &#40;F&#35;&#41;](Constructors+28%F%2329%.md)|Used in conditional expressions.<br /><br />Also used to perform side effects after object construction.|
